<footer class="fc-footer mt-5">
    <div class="container">
        ...
        <!-- Mobile/tablet footer (compact + accordion) -->
        <div class="d-lg-none fc-footer-mobile">
            <div class="py-4">
                <div class="d-flex align-items-center justify-content-between gap-3">
                    <img src="{{ asset(config('store.logo_primary_path')) }}" alt="{{ config('store.logo_alt') }}" style="height:32px;width:auto;">
                    <span class="fc-pill-soft">Premium Store</span>
                </div>
                <p class="text-muted small mt-2 mb-0">{{ config('store.short_description') }}</p>
            </div>

            <div class="fc-footer-mobile-trust">
                <div class="row g-2">
                    <div class="col-4"><div class="fc-footer-mobile-trust-item">Fast shipping</div></div>
                    <div class="col-4"><div class="fc-footer-mobile-trust-item">Easy returns</div></div>
                    <div class="col-4"><div class="fc-footer-mobile-trust-item">Secure checkout</div></div>
                </div>
            </div>

            <div class="accordion fc-footer-acc" id="fcFooterAcc">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="fcFootShopHead">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fcFootShop" aria-expanded="false" aria-controls="fcFootShop">
                            Shop
                        </button>
                    </h2>
                    <div id="fcFootShop" class="accordion-collapse collapse" aria-labelledby="fcFootShopHead" data-bs-parent="#fcFooterAcc">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="fcFootCustHead">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fcFootCust" aria-expanded="false" aria-controls="fcFootCust">
                            Customer
                        </button>
                    </h2>
                    <div id="fcFootCust" class="accordion-collapse collapse" aria-labelledby="fcFootCustHead" data-bs-parent="#fcFooterAcc">
                        <div class="accordion-body">
                            <div class="d-flex flex-column gap-2">
                                <a href="{{ route('cart.index') }}">Cart</a>
                                <a href="{{ route('checkout.index') }}">Checkout</a>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="fcFootContactHead">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fcFootContact" aria-expanded="false" aria-controls="fcFootContact">
                            Contact
                        </button>
                    </h2>
                    <div id="fcFootContact" class="accordion-collapse collapse" aria-labelledby="fcFootContactHead" data-bs-parent="#fcFooterAcc">
                        <div class="accordion-body">
                            <div class="text-muted small">
                                @if($email !== '')
            ...
            <div class="fc-footer-meta d-flex flex-column gap-1 mt-4 pt-3">
